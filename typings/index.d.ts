...
declare module 'rengar' {
  ...
  class RengarClass {
    ...
    public Match: {
      get: (matchID: number) => RengarRequest<dtos.MatchV5ListDTO>
      puuid: (puuid: string) => RengarRequest<dtos.MatchV5DTO>
      timeline: (matchID: number) => RengarRequest<dtos.MatchV5TimelineDTO>

      Tournament: {
        listMatchIDs: (tournamentCode: string) => RengarRequest<number[]>
        get: (matchID: number, tournamentCode: string) => RengarRequest<dtos.MatchV5DTO>
      }
    }
    public Status: {
...
export namespace METHOD_NAMES {
  ...
  namespace MATCH {
    ...
    // V5
    const GET_MATCH_V5 = 'MATCH.GET_V5'
    const GET_MATCHLIST_V5 = 'MATCH.GET_LIST_V5'
    const GET_MATCH_TIMELINE_V5 = 'MATCH.GET_TIMELINE_V5'

    //Tounrnament
    const GET_MATCH_IDS_BY_TOURNAMENT_CODE_V5 = 'MATCH.GET_MATCH_IDS_BY_TOURNAMENT_CODE_V4'
    const GET_MATCH_BY_TOURNAMENT_CODE_V5 = 'MATCH.GET_MATCH_BY_TOURNAMENT_CODE_V4'
  }
